                            ...
                            <thead>
                                <tr class="v-border-hr select-none border-b-2 border-gray-300" >
                                  <th class="v-table-title py-2 text-sm font-bold text-white text-left px-1 sorting"  style="width: 36px;">
                                        ACCID
                                    </th><th class="v-table-title py-2 text-sm font-bold text-white text-left px-1 sorting"  style="width: 64px;">
                                        DANH MỤC
                                    </th><th class="v-table-title py-2 text-sm font-bold text-white text-left px-1 sorting" 
                                     style="width: 61px;">
                                        TÊN GAME
                                    </th><th class="v-table-title py-2 text-sm font-bold text-white text-left px-1 sorting"  style="width: 65px;">
                                        TÀI KHOẢN
                                    </th><th class="v-table-title py-2 text-sm font-bold text-white text-left px-1 sorting"  style="width: 63px;">
                                        MẬT KHẨU
                                    </th><th class="v-table-title py-2 text-sm font-bold text-white text-left px-1 sorting"  style="width: 51px;">
                                        MUA GIÁ
                                    </th><th class="v-table-title py-2 text-sm font-bold text-white text-left px-1 sorting"  style="width: 92px;">
                                        THỜI GIAN MUA
                                    </th></tr>
                            </thead> 
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?= $history->name ?></td>
                                    <td><?= $history->account_username ?></td>
                                    <td><?= $history->account_password ?></td>
                                    <td><?= $history->price ?></td>
