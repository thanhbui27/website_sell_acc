                    ...
                    <div class="p-2 border border-gray-300 mb-4">
                        ...
                        <div>
                            <div class="border-t border-gray-200 mt-2 p-2 select-text">
                                <div class="relative">
                                    <p><font color="#ffffff"><b>100k ATM =&nbsp; 100k Trên Shop</b></font></p><p><font color="#ffffff" style="font-size: 1rem;"><b>!! Lưu Ý : Bank Sai Nội Dung Chuyển Khoản Trừ 10%</b></font><strong style="font-size: 1rem;"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;" color="#ffffff">&nbsp;Tiền</font></font></strong><br></p><p><font color="#ff0000" style="background-color: rgb(247, 247, 247);"><span class="text-big" style=""><strong style=""><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">nạp tiền quá 10 phút chưa cộng tiền ib zalo :&nbsp;</font></font></strong></span><span style="font-size: 20px; font-weight: 700;">0377928648</span></font></p>                                    <p style="margin-left: 0px;">&nbsp;</p>
                                    <p>&nbsp;</p>
                            ...
                            <div class="border-t border-gray-200 w-full select-text">
                                <div class="p-2">
                                    ...
                                    <div class="my-2 items-center w-full text-center"><span class="font-bold border-dashed border border-red-600 rounded inline-flex justify-center text-center text-red-500 py-1 rounded px-4">
                                            <b id="copyNoiDung">NAP TIEN267</b>
                                        </span> <button type="button" class="copy ml-1 bg-gray-500 font-semibold text-white rounded focus:outline-none py-1 px-3" data-clipboard-target="#copyNoiDung">
                                            Sao chép
                                        </button></div>
                                </div>
                            </div>
