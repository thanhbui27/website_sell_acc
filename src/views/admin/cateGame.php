            ...
            <div class="card-body px-0 pt-0 pb-2">
              <div class="table-responsive p-0 p-2">
                <table id="tableAccount" class="table align-items-center mb-0 "  style="border-bottom:1px solid #efefef">
                  ...
                  <tbody>
                    <?php foreach($data["cateGame"] as $bill): ?>
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="modalEditGameLabel">Chỉnh sửa danh mục game mới</h5>
    ...
    <script> 
      $(document).ready(function() {
        ...
        $("#saveModalCate").on("click", function(){
          performAction({
            url : "<?= URLADMINROOT ?>/dashboard/games/cate-game/action",
            method : "POST",
            dataCustom : {
              action : "edit",
              id : $("#id-hidden").val(),
              content : $('#recipient-name').val(),
